...
### [2] [AIGOR: A Modular, Event-Driven Neuromorphic Architecture for Configurable SNN Inference](https://arxiv.org/abs/2607.03191)
...
### [3] [Towards transferable lightweight neuromorphic computing through a model-free temporal-switch framework](https://arxiv.org/abs/2607.02608)
...
### [4] [FAPlace: Joint Optimization of Chiplet Placement and Interposer Footprint for 2.5D Systems](https://arxiv.org/abs/2607.02610)
...
### [5] [HyNoC: A Hybrid Circuit-Switch/Wormhole Network-on-Chip for Distributed VLIW Computing on FPGA](https://arxiv.org/abs/2607.02729)
*Christophe Clienti*
...
### [12] [Graph-VQE: A CUDA-Q Multi-QPU Simulation Framework for Hamiltonian-Aware Protein-Folding VQE](https://arxiv.org/abs/2607.02749)
...
### [13] [Continuous-time nonlinear closed-loop in-memory computing for high-accuracy massive MIMO detection](https://arxiv.org/abs/2607.02842)
...
### [14] [Handover-Optimal User Association Policy for LEO Satellite-based 5G NTN](https://arxiv.org/abs/2607.04829)
...
### [15] [Optimizing ML Workload Partitioning between CPUs and CIM Accelerators for Heterogeneous Computing](https://arxiv.org/abs/2607.05240)
