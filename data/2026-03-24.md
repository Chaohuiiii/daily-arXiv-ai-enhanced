...
### [1] [Self-Heating and Parasitic Effects in Multi-Tier CFET Design](https://arxiv.org/abs/2603.21910)
...
### [2] [COmPOSER: Circuit Optimization of mm-wave/RF circuits with Performance-Oriented Synthesis for Efficient Realizations](https://arxiv.org/abs/2603.20486)
...
### [3] [MINISA: Minimal Instruction Set Architecture for Next-gen Reconfigurable Inference Accelerator](https://arxiv.org/abs/2603.20623)
...
### [4] [PC2IM: An Efficient In-Memory Computing Accelerator for 3D Point Cloud](https://arxiv.org/abs/2603.21167)
...
### [5] [DS2SC-Agent: A Multi-Agent Automated Pipeline for Rapid Chiplet Model Generation](https://arxiv.org/abs/2603.21190)
...
### [6] [IMMSched: Interruptible Multi-DNN Scheduling via Parallel Multi-Particle Optimizing Subgraph Isomorphism](https://arxiv.org/abs/2603.21659)
...
### [7] [Quantifying Uncertainty in FMEDA Safety Metrics: An Error Propagation Approach for Enhanced ASIC Verification](https://arxiv.org/abs/2603.21770)
...
### [8] [Convolutions Predictable Offloading to an Accelerator: Formalization and Optimization](https://arxiv.org/abs/2603.21792)
