...
### [1] [An Instruction Set Architecture for IMPLY-based Memristive Processing-in-Array](https://arxiv.org/abs/2606.27319)
...
### [3] [The Kernel's Write: Application Read-Only Memory](https://arxiv.org/abs/2606.26138)
...
### [4] [Toward Mitigating Process-Induced Performance Degradation in 3.5D Heterogeneous Packages via Pre-Silicon Firmware Co-Optimization](https://arxiv.org/abs/2606.26176)
...
### [5] [CVA6-RT: an Open-Source Time-Predictable RV64 Processor for Mixed-Criticality Systems](https://arxiv.org/abs/2606.26177)
...
### [6] [Nanoelectromechanical Systems (NEMS) for Hardware Security in Advanced Packaging](https://arxiv.org/abs/2606.26426)
...
### [7] [GRAINS: Storage-Aware Algorithm-Architecture Co-Design Enabling High-Performance and Low-Cost Graph-Based Genome Analysis](https://arxiv.org/abs/2606.26468)
...
### [8] [SegFold: Accelerating Sparse GEMM with a Fine-Grained Dynamic Dataflow](https://arxiv.org/abs/2606.26701)
...
### [9] [Residual GPU Cache State on Apple M4 Pro](https://arxiv.org/abs/2606.27098)
