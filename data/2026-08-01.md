...
### [4] [Analog Courant Numbers and their Role in Analog Computing](https://arxiv.org/abs/2607.27609)
*Arash Ghasemi*
...
### [5] [GyRot: Leveraging Hidden Synergy between Rotation and Fine-grained Group Quantization for Low-bit LLM Inference](https://arxiv.org/abs/2607.27694)
...
### [6] [LightRot: A Light-Weighted Rotation Scheme and Architecture for Accurate Low-Bit Large Language Model Inference](https://arxiv.org/abs/2607.27704)
...
### [7] [ARES: Adaptive Reasoning-Effort Steering for PPA- and Cost-Aware RTL Optimization with LLM Agents](https://arxiv.org/abs/2607.27879)
...
### [8] [Demystifying DRAM Read Disturbance: Bridging the Gap Between Experimental Characterization and Device-Level Modeling of RowHammer and RowPress Phenomena](https://arxiv.org/abs/2607.28233)
