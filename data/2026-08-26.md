...
### [1] [A unified dynamical modeling framework for cruise control and adaptive cruise control](https://arxiv.org/abs/2608.23827)
...
### [2] [Small-World Communication Fabrics for Neuromorphic Multicore-SoCs](https://arxiv.org/abs/2608.24351)
...
### [3] [HORIZON: A Read-Efficient Firmware for DNA Storage with Horizontal Layout](https://arxiv.org/abs/2608.24839)
...
### [4] [Transformer Accelerator (TFA): A Macro-Op INT8 Hardware Chip for Transformer Inference and Machine Translation](https://arxiv.org/abs/2608.23582)
*Shashank*
...
### [5] [Squeezing the Cache, Preserving the Truth: Monotonic Equipotential Allocation with Geodesia-KV](https://arxiv.org/abs/2608.23599)
...
### [6] [StateTune: Transforming LLM-Assisted EDA Flow Tuning into a Stateful, Closed-Loop Process](https://arxiv.org/abs/2608.23601)
...
### [7] [Maia 200: A Software Defined Dataflow System for Large-scale AI Acceleration](https://arxiv.org/abs/2608.24664)
...
### [8] [PACT: Post-route Agentic Checkpoint Tuning for FPGA Timing Closure](https://arxiv.org/abs/2608.23602)
...
### [9] [Elastic KV Cache for LLM Serving:A Working Reclamation Mechanism, and Why Chunked Prefill Already Closes the Gap](https://arxiv.org/abs/2608.23658)
...
### [10] [Pipeline-Native Transformers: Co-Designing Model Architecture and CPU Inference for Bandwidth-Efficient Autoregressive Decode](https://arxiv.org/abs/2608.23841)
*Tom Poperszky*
...
### [11] [Thermal Tuning Overhead in Wafer-Scale Optical Interconnects for LLM MoE Training: A Cross-Layer Analysis and Ferroelectric-Based Mitigation](https://arxiv.org/abs/2608.24637)
...
### [12] [Simthesizer: An Agent-Driven Simulation Framework for LLM Serving Systems](https://arxiv.org/abs/2608.24650)
